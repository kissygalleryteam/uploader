...
kg/uploader/2.0.3/type/base
kg/uploader/2.0.3/type/iframe
kg/uploader/2.0.3/type/ajax
kg/uploader/2.0.3/type/flash
kg/uploader/2.0.3/button/base
kg/uploader/2.0.3/plugins/ajbridge/ajbridge
kg/uploader/2.0.3/plugins/ajbridge/uploader
kg/uploader/2.0.3/button/swfButton
kg/uploader/2.0.3/queue
kg/uploader/2.0.3/index
 ...
 **/
KISSY.add('kg/uploader/2.0.3/type/base',function(S, Node, Base) {
    var EMPTY = '',$ = Node.all;
 ...
 * @author 剑平（明河）<minghe36@126.com>,紫英<daxingplay@gmail.com>
 **/
KISSY.add('kg/uploader/2.0.3/type/iframe',function(S, Node, UploadType) {
 ...
 * @author 剑平（明河）<minghe36@126.com>,紫英<daxingplay@gmail.com>
 **/
KISSY.add('kg/uploader/2.0.3/type/ajax',function(S, Node, UploadType,io) {
 ...
 **/
KISSY.add('kg/uploader/2.0.3/type/flash',function (S, Node, UploadType) {
 ...
 **/
KISSY.add('kg/uploader/2.0.3/button/base',function(S, Node, Base) {
    var EMPTY = '',
 ...
 */
KISSY.add('kg/uploader/2.0.3/plugins/ajbridge/ajbridge',function(S,Flash,Event) {
 ...
 * @author kingfo  oicuicu@gmail.com
 */
KISSY.add('kg/uploader/2.0.3/plugins/ajbridge/uploader',function(S,flash,A) {
 ...
 * @author: 紫英(橘子)<daxingplay@gmail.com>, 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('kg/uploader/2.0.3/button/swfButton',function (S, Node, Base, SwfUploader) {
    var EMPTY = '', $ = Node.all,
 ...
 * @author 剑平（明河）<minghe36@126.com>,紫英<daxingplay@gmail.com>
 **/
KISSY.add('kg/uploader/2.0.3/queue',function (S, Node, Base) {
 ...
 * @author 剑平（明河）<minghe36@126.com>,紫英<daxingplay@gmail.com>
 **/
KISSY.add('kg/uploader/2.0.3/index',function (S, Node, RichBase,JSON,UA,IframeType, AjaxType, FlashType, HtmlButton, SwfButton, Queue) {
