...
kg/uploader/2.0.3/plugins/mobileUploader/xmppUtil
kg/uploader/2.0.3/plugins/mobileUploader/qrcode
kg/uploader/2.0.3/plugins/mobileUploader/mobileUploader

*/
KISSY.add('kg/uploader/2.0.3/plugins/mobileUploader/xmppUtil',function(S){
...
KISSY.add('kg/uploader/2.0.3/plugins/mobileUploader/qrcode',function(S,Node, UA, XmppUtil){
 ...
 **/
KISSY.add('kg/uploader/2.0.3/plugins/mobileUploader/mobileUploader',function(S, Node, Base,QR) {
    var EMPTY = '';
    var $ = Node.all;
