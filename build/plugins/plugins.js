...
kg/uploader/2.0.3/plugins/auth/auth
kg/uploader/2.0.3/plugins/filedrop/filedrop
kg/uploader/2.0.3/plugins/imageZoom/imageZoom
kg/uploader/2.0.3/plugins/imgcrop/imgcrop
kg/uploader/2.0.3/plugins/preview/preview
kg/uploader/2.0.3/plugins/proBars/progressBar
kg/uploader/2.0.3/plugins/proBars/proBars
kg/uploader/2.0.3/plugins/tagConfig/tagConfig
kg/uploader/2.0.3/plugins/urlsInput/urlsInput
kg/uploader/2.0.3/plugins/paste/paste
kg/uploader/2.0.3/token
kg/uploader/2.0.3/plugins/miniLogin/miniLogin
kg/uploader/2.0.3/plugins/plugins
 ...
 **/
KISSY.add('kg/uploader/2.0.3/plugins/auth/auth',function (S, Node,Base) {
    var EMPTY = '';
    var $ = Node.all;
 ...
 *  @author 飞绿
 */
KISSY.add('kg/uploader/2.0.3/plugins/filedrop/filedrop',function (S, Node, Base) {
    var EMPTY = '',
        $ = Node.all,
        UA = S.UA;
    /**
 ...
 * @author 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('kg/uploader/2.0.3/plugins/imageZoom/imageZoom',function(S, Node, Base,Albums) {
    var EMPTY = '';
    var $ = Node.all;
    /**
     * @name ImageZoom
 ...
 * @author 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('kg/uploader/2.0.3/plugins/imgcrop/imgcrop',function(S, Node,Base,ImgCrop) {
    var EMPTY = '';
    var $ = Node.all;
    /**
     * @name ImgCropPlugin
...
KISSY.add('kg/uploader/2.0.3/plugins/preview/preview',function (S,Node, D, E,Base,ua) {
    var $ = Node.all;
    var doc = document,
 ...
 * @author 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('kg/uploader/2.0.3/plugins/proBars/progressBar',function(S, Node, Base) {
    var EMPTY = '',$ = Node.all,
 ...
 * @author 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('kg/uploader/2.0.3/plugins/proBars/proBars',function(S, Node, Base,ProgressBar) {
    var EMPTY = '';
    var $ = Node.all;
 ...
 * @author 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('kg/uploader/2.0.3/plugins/tagConfig/tagConfig',function(S, Node, Base) {
    var EMPTY = '';
    var $ = Node.all;
 ...
 * @author: 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('kg/uploader/2.0.3/plugins/urlsInput/urlsInput',function(S, Node, Base) {
 ...
 * @author 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('kg/uploader/2.0.3/plugins/paste/paste',function(S, Node, Base) {
    var EMPTY = '';
    var $ = Node.all;
    /**
     * @name Paste
 ...
 * _获取tokenֵ
 */
KISSY.add('kg/uploader/2.0.3/token',function (S ,io) {
 ...
 * @author 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('kg/uploader/2.0.3/plugins/miniLogin/miniLogin',function(S, Node, Base,token,ML) {
    var EMPTY = '';
    var $ = Node.all;
 ...
 *           - 新增插件
 */
KISSY.add('kg/uploader/2.0.3/plugins/plugins',function(S,Auth,Filedrop,ImageZoom,Imgcrop,Preview,ProBars,TagConfig,UrlsInput,Paste,MiniLogin) {
    /**
     * 所有的插件集合
     */
    return {
