...
kg/uploader/3.0.0/themes/default/index
 ...
 * @author 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('kg/uploader/3.0.0/themes/default/index',function (S, Node, Theme) {
    var EMPTY = '', $ = Node.all;
    ...
    S.extend(DefaultTheme, Theme, /** @lends DefaultTheme.prototype*/{
        ...
        fileTpl:{value:
            '<li id="queue-file-{id}" class="grid" data-name="{name}">' +
                ...
                '<div class="J_ProgressBar_{id} g-u uploader-progress"><img class="loading" src="//img01.taobaocdn.com/tps/i1/T1F5tVXjRfXXXXXXXX-16-16.gif" alt="loading" /></div>' +
