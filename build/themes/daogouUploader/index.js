...
kg/uploader/2.0.2/themes/daogouUploader/index
 ...
 **/
KISSY.add('kg/uploader/2.0.2/themes/daogouUploader/index',function (S, Node, DefaultTheme) {
    var EMPTY = '', $ = Node.all;
    ...
    return Daogou;
}, {requires:['node', 'kg/kg/uploader/2.0.2/2.0.1/themes/default/index']});
/**
 * changes:
 * 明河：1.4
 *           - 继承于Default主题
