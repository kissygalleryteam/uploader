...
kg/uploader/3.0.1/themes/wankeUploader/index
 ...
 * @author 灵吾
 **/
KISSY.add('kg/uploader/3.0.1/themes/wankeUploader/index',function (S, Node, Theme) {
    var EMPTY = '', $ = Node.all;
...
}, {requires:['node', 'kg/kg/uploader/3.0.1/2.0.1/theme']});
