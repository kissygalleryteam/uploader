...
kg/uploader/3.0.1/plugins/cross/xmppUtil
kg/uploader/3.0.1/plugins/cross/qrcode
kg/uploader/3.0.1/plugins/cross/cross

*/
KISSY.add('kg/uploader/3.0.1/plugins/cross/xmppUtil',function(S){
...
KISSY.add('kg/uploader/3.0.1/plugins/cross/qrcode',function(S,Node, UA, XmppUtil){
 ...
 **/
KISSY.add('kg/uploader/3.0.1/plugins/cross/cross',function(S, Node, Base,QR) {
    var EMPTY = '';
    var $ = Node.all;
