...
kg/uploader/3.0.0/plugins/auth/auth
kg/uploader/3.0.0/plugins/filedrop/filedrop
kg/uploader/3.0.0/plugins/imageZoom/imageZoom
kg/uploader/3.0.0/plugins/imgcrop/imgcrop
kg/uploader/3.0.0/plugins/preview/preview
kg/uploader/3.0.0/plugins/proBars/progressBar
kg/uploader/3.0.0/plugins/proBars/proBars
kg/uploader/3.0.0/plugins/tagConfig/tagConfig
kg/uploader/3.0.0/plugins/urlsInput/urlsInput
kg/uploader/3.0.0/plugins/paste/paste
kg/uploader/3.0.0/plugins/miniLogin/miniLogin
kg/uploader/3.0.0/plugins/plugins
 ...
 **/
KISSY.add('kg/uploader/3.0.0/plugins/auth/auth',function (S, Node,Base) {
    var EMPTY = '';
    var $ = Node.all;
 ...
 *  @author 飞绿
 */
KISSY.add('kg/uploader/3.0.0/plugins/filedrop/filedrop',function (S, Node, Base) {
    var EMPTY = '',
        $ = Node.all,
        UA = S.UA;
    /**
 ...
 * @author 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('kg/uploader/3.0.0/plugins/imageZoom/imageZoom',function(S, Node, Base,Albums) {
    var EMPTY = '';
    var $ = Node.all;
    /**
     * @name ImageZoom
 ...
 * @author 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('kg/uploader/3.0.0/plugins/imgcrop/imgcrop',function(S, Node,Base,ImgCrop) {
    var EMPTY = '';
    var $ = Node.all;
    /**
     * @name ImgCropPlugin
...
KISSY.add('kg/uploader/3.0.0/plugins/preview/preview',function (S,Node, D, E,Base,ua) {
    var $ = Node.all;
    var doc = document,
 ...
 * @author 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('kg/uploader/3.0.0/plugins/proBars/progressBar',function(S, Node, Base) {
    var EMPTY = '',$ = Node.all,
 ...
 * @author 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('kg/uploader/3.0.0/plugins/proBars/proBars',function(S, Node, Base,ProgressBar) {
    var EMPTY = '';
    var $ = Node.all;
 ...
 * @author 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('kg/uploader/3.0.0/plugins/tagConfig/tagConfig',function(S, Node, Base) {
    var EMPTY = '';
    var $ = Node.all;
 ...
 * @author: 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('kg/uploader/3.0.0/plugins/urlsInput/urlsInput',function(S, Node, Base) {
 ...
 * @author 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('kg/uploader/3.0.0/plugins/paste/paste',function(S, Node, Base) {
    var EMPTY = '';
    var $ = Node.all;
    /**
     * @name Paste
 ...
 * @author 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('kg/uploader/3.0.0/plugins/miniLogin/miniLogin',function(S, Node, Base,token,ML) {
    var EMPTY = '';
    var $ = Node.all;
 ...
 *           - 新增插件
 */
KISSY.add('kg/uploader/3.0.0/plugins/plugins',function(S,Auth,Filedrop,ImageZoom,Imgcrop,Preview,ProBars,TagConfig,UrlsInput,Paste,MiniLogin) {
    /**
     * 所有的插件集合
     */
    return {
