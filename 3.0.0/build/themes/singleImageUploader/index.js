...
kg/uploader/3.0.0/theme
kg/uploader/3.0.0/themes/imageUploader/index
kg/uploader/3.0.0/themes/singleImageUploader/index
...
KISSY.add('kg/uploader/3.0.0/theme',function (S, Node, Base) {
    var EMPTY = '';
    var $ = Node.all;
    //主题样式名前缀
 ...
 * @author 苏河、紫英、明河
 **/
KISSY.add('kg/uploader/3.0.0/themes/imageUploader/index',function (S, Node, Theme) {
    var EMPTY = '', $ = Node.all;
 ...
 * @author 明河、溪夏
 **/
KISSY.add('kg/uploader/3.0.0/themes/singleImageUploader/index',function (S, Node, ImageUploader) {
    var EMPTY = '', $ = Node.all;
