...
gallery/uploader/1.5.4/button/swfButton
 ...
 **/
KISSY.add('gallery/uploader/1.5.4/type/flash',function (S, Node, UploadType) {
 ...
 * @author: 紫英(橘子)<daxingplay@gmail.com>, 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('gallery/uploader/1.5.4/button/swfButton',function (S, Node, Base, SwfUploader) {
    var EMPTY = '', $ = Node.all,
    ...
    S.extend(SwfButton, Base, /** @lends SwfButton.prototype*/{
         ...
         * @type Object
         * @default { src:'http://a.tbcdn.cn/s/kissy/gallery/uploader/1.5.4/plugins/ajbridge/uploader.swf', id:'swfUploader', params:{ bgcolor:"#fff", wmode:"transparent" }, attrs:{ }, hand:true, btn:true }
             }
         */
        flash:{
            value:{
                src:'http://a.tbcdn.cn/s/kissy/gallery/uploader/1.5.4/plugins/ajbridge/uploader.swf',
                id:'swfUploader',
                params:{
                    bgcolor:"#fff",
                    wmode:"transparent"
 ...
 * @author 剑平（明河）<minghe36@126.com>,紫英<daxingplay@gmail.com>
 **/
KISSY.add('gallery/uploader/1.5.4/index',function (S, Node, RichBase,JSON,UA,IframeType, AjaxType, FlashType, HtmlButton, SwfButton, Queue) {
 ...
 * 阿里上传通用接口
 */
KISSY.add('gallery/uploader/1.5.4/aliUploader',function (S ,UA,Uploader,token) {
