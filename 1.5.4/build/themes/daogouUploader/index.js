...
gallery/uploader/1.5.4/themes/daogouUploader/index
 ...
 **/
KISSY.add('gallery/uploader/1.5.4/themes/daogouUploader/index',function (S, Node, DefaultTheme) {
    var EMPTY = '', $ = Node.all;
    ...
    return Daogou;
}, {requires:['node', 'gallery/gallery/uploader/1.5.4/themes/default/index']});
/**
 * changes:
 * 明河：1.4
 *           - 继承于Default主题
