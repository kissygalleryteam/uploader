...
gallery/uploader/1.5.4/themes/ershouUploader/index
 ...
 **/
KISSY.add('gallery/uploader/1.5.4/themes/ershouUploader/index', function (S, Node, ImageUploader) {
    var EMPTY = '';
    var $ = Node.all;
    ...
    S.extend(ErshouUploader, ImageUploader, /** @lends ErshouUploader.prototype*/ {
    	...
    	ATTRS: /** @lends ErshouUploader.prototype*/ {
	         ...
	         * css模块路径
	         * @type String
	         * @default "gallery/uploader/1.5.4/themes/ershouUploader/style.css"
	         */
	        cssUrl: { 
	        	value: 'gallery/uploader/1.5.4/themes/ershouUploader/style.css'
			},
	        /**
	         * 队列使用的模板
	         * @type String
	...
	requires:[ 'node', 'gallery/gallery/uploader/1.5.4/themes/imageUploader/index' ]
});
/**
 * changes:
 * 明河：1.4
