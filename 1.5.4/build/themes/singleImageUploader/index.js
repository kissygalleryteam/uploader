...
gallery/uploader/1.5.4/themes/imageUploader/index
gallery/uploader/1.5.4/themes/singleImageUploader/index
 ...
 * @author 苏河、紫英、明河
 **/
KISSY.add('gallery/uploader/1.5.4/themes/imageUploader/index',function (S, Node, Theme) {
    var EMPTY = '', $ = Node.all;
 ...
 * @author 明河、溪夏
 **/
KISSY.add('gallery/uploader/1.5.4/themes/singleImageUploader/index',function (S, Node, ImageUploader) {
    var EMPTY = '', $ = Node.all;
