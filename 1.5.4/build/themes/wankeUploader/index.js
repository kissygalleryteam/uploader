...
gallery/uploader/1.5.4/themes/wankeUploader/index
 ...
 * @author 灵吾
 **/
KISSY.add('gallery/uploader/1.5.4/themes/wankeUploader/index',function (S, Node, Theme) {
    var EMPTY = '', $ = Node.all;
...
}, {requires:['node', 'gallery/gallery/uploader/1.5.4/theme']});
